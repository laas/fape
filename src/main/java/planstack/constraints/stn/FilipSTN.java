 ...
 * tried in context of ordering queries on planstack.constraints.stn.FilipSTN. The aggregated propagation could
...
class FilipSTN {
     ...
     * @return makespan
     */
    /*public FilipSTNEval eval() {
     int sum = 0;
     for (int i = 0; i < ends_count; i++) {
     sum += ga(0, i + 2);
     }
     return new FilipSTNEval(ga(0, 1), sum);
     }*/
    /**
     *
     */
    ...
    public int ga(int var1, int var2) {
        if (var1 < var2) {
            ...
            return edge_a[FilipSTN.precalc[var1][var2]];
        }
    }
    ...
    public int gb(int var1, int var2) {
        if (var1 < var2) {
            ...
            return edge_b[FilipSTN.precalc[var1][var2]];
        }
    }
    ...
    /*    public FilipSTNedge ge(int var1, int var2){
     return new FilipSTNedge(ga(var1,var2),gb(var1,var2));
     }*/
    /*    public void se(int var1, int var2, int a, int b){
     sa(var1,var2,a);
     sb(var1,var2,b);
     }*/
    /*    public void se(int var1, int var2, FilipSTNedge e){
     sa(var1,var2,e.a);
     sb(var1,var2,e.b);
     }*/
     ...
     *
     * @param subFilipSTN subnetwork
     */
    /*
    public void update_with_subFilipSTN(TinyFilipSTN subFilipSTN) {
        for (int i = 0; i < subFilipSTN.top; i++) {
            for (int j = 0; j < i; j++) {
                if (this.edge_consistent(TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[i], TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[j], subFilipSTN.ga(TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[i], TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[j]), subFilipSTN.gb(TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[i], TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[j]))) {
                    this.propagate(TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[i], TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[j], subFilipSTN.ga(TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[i], TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[j]), subFilipSTN.gb(TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[i], TinyFilipSTN.mapping_TinyFilipSTN_to_FilipSTN[j]));
                } else {
                    throw new UnsupportedOperationException("This is really Fatal. We have lost the integrity of the planstack.constraints.stn.FilipSTN.");
                }
            }
        }
    }
