...
public class DisjunctiveFluent {
    ...
    public DisjunctiveFluent(ParameterizedStateVariable sv, VarRef value, PartialPlan st, Planner planner) {
        this.fluents = new HashSet<>(fluentsOf(sv, value, st, planner));
    }

    public static Set<Fluent> fluentsOf(ParameterizedStateVariable sv, VarRef value, PartialPlan st, Planner planner) {
    ...
    public static Set<GStateVariable> instantiationsOf(ParameterizedStateVariable sv, PartialPlan st) {
