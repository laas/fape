...
public class Experiments {
    public static void main(String[] args) throws InterruptedException, Exception {
        ...
        */
        ...
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/elevators/anmlComplicate/", "--planner rpg --strats lcf|lfr --quiet");
        */
        ...
        //AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/elevators/anml/", "--planner rpg --strats lcf|lfr --quiet");
        /*
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/HandOver/", "--planner rpg --strats lcf>abs|soca --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/HandOver/", "--planner rpg --strats lcf>abs|lmc --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/HandOver/", "--planner rpg --strats lcf>abs|lmc>soca --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/HandOver/", "--planner rpg --strats lcf>abs|lmc>lfr --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/HandOver/", "--planner rpg --strats lcf>abs|soca>lfr --quiet");
        
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/Rovers/", "--planner rpg --strats lcf>abs|soca --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/Rovers/", "--planner rpg --strats lcf>abs|lmc --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/Rovers/", "--planner rpg --strats lcf>abs|lmc>soca --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/Rovers/", "--planner rpg --strats lcf>abs|lmc>lfr --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/Rovers/", "--planner rpg --strats lcf>abs|soca>lfr --quiet");       */
        
        /*AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/elevators/anmlComplicate/", "--planner rpg --strats lcf>abs|soca --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/elevators/anmlComplicate/", "--planner rpg --strats lcf>abs|lmc --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/elevators/anmlComplicate/", "--planner rpg --strats lcf>abs|lmc>soca --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/elevators/anmlComplicate/", "--planner rpg --strats lcf>abs|lmc>lfr --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/elevators/anmlComplicate/", "--planner rpg --strats lcf>abs|soca>lfr --quiet");*/
        
        /*AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/visitall/anml/", "--planner rpg --strats lcf>abs|soca --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/visitall/anml/", "--planner rpg --strats lcf>abs|lmc --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/visitall/anml/", "--planner rpg --strats lcf>abs|lmc>soca --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/visitall/anml/", "--planner rpg --strats lcf>abs|lmc>lfr --quiet");
        AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/visitall/anml/", "--planner rpg --strats lcf>abs|soca>lfr --quiet");*/
        
        //AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/scaling/", "--planner base --strats lcf>abs|soca --quiet");
        //AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/scaling/", "--planner base --strats lcf>abs|lmc --quiet");
        //AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/scaling/", "--planner base --strats lcf>abs|lmc>soca --quiet");
        //AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/scaling/", "--planner base --strats lcf>abs|lmc>lfr --quiet");
        //AnotherExperimentRunner.run("C:/ROOT/PROJECTS/fape/FAPE/problems/scaling/", "--planner base --strats lcf>abs|soca>lfr --quiet");
