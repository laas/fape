...
public abstract class Handler {
    ...
    public final void addOperation(SearchNode n, StateLifeTime time, APlanner planner) {
        n.addOperation(s -> {
    ...
    public void actionInserted(Action a, State st, APlanner planner) {}
    public void taskInserted(Task a, State st, APlanner planner) {}
