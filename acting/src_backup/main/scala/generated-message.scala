...
package tf2_msgs {
  case class SLookupTransformActionGoal(
      @BeanProperty var header: _root_.std_msgs.Header,
      @BeanProperty var goalId: _root_.actionlib_msgs.GoalID,
      @BeanProperty var goal: _root_.tf2_msgs.LookupTransformGoal)
    extends AbsMsg with _root_.tf2_msgs.LookupTransformActionGoal

  case class SFrameGraphResponse(
      @BeanProperty var frameYaml: String)
    extends AbsMsg with _root_.tf2_msgs.FrameGraphResponse

  case class SLookupTransformFeedback(
      )
    extends AbsMsg with _root_.tf2_msgs.LookupTransformFeedback

  case class SLookupTransformGoal(
      @BeanProperty var targetFrame: String,
      @BeanProperty var sourceFrame: String,
      @BeanProperty var sourceTime: org.ros.message.Time,
      @BeanProperty var timeout: org.ros.message.Duration,
      @BeanProperty var targetTime: org.ros.message.Time,
      @BeanProperty var fixedFrame: String,
      @BeanProperty var advanced: Boolean)
    extends AbsMsg with _root_.tf2_msgs.LookupTransformGoal

  case class SLookupTransformActionResult(
      @BeanProperty var header: _root_.std_msgs.Header,
      @BeanProperty var status: _root_.actionlib_msgs.GoalStatus,
      @BeanProperty var result: _root_.tf2_msgs.LookupTransformResult)
    extends AbsMsg with _root_.tf2_msgs.LookupTransformActionResult
  ...
  case class SLookupTransformAction(
      @BeanProperty var actionGoal: _root_.tf2_msgs.LookupTransformActionGoal,
      @BeanProperty var actionResult: _root_.tf2_msgs.LookupTransformActionResult,
      @BeanProperty var actionFeedback: _root_.tf2_msgs.LookupTransformActionFeedback)
    extends AbsMsg with _root_.tf2_msgs.LookupTransformAction

  case class SLookupTransformActionFeedback(
      @BeanProperty var header: _root_.std_msgs.Header,
      @BeanProperty var status: _root_.actionlib_msgs.GoalStatus,
      @BeanProperty var feedback: _root_.tf2_msgs.LookupTransformFeedback)
    extends AbsMsg with _root_.tf2_msgs.LookupTransformActionFeedback

  case class SLookupTransformResult(
      @BeanProperty var transform: _root_.geometry_msgs.TransformStamped,
      @BeanProperty var error: _root_.tf2_msgs.TF2Error)
    extends AbsMsg with _root_.tf2_msgs.LookupTransformResult
...
package adream_actions {
  ...
  case class SItemLocation(
      @BeanProperty var item: String,
      @BeanProperty var room: String,
      @BeanProperty var location: String)
    extends AbsMsg with _root_.adream_actions.ItemLocation

  case class SReleaseResponse(
      @BeanProperty var status: Int)
    extends AbsMsg with _root_.adream_actions.ReleaseResponse

  case class SItemLocationsResponse(
      @BeanProperty var locations: java.util.List[_root_.adream_actions.ItemLocation])
    extends AbsMsg with _root_.adream_actions.ItemLocationsResponse

  case class SPickRequest(
      @BeanProperty var label: String)
    extends AbsMsg with _root_.adream_actions.PickRequest

  case class SItemLocationsRequest(
      @BeanProperty var unused: String)
    extends AbsMsg with _root_.adream_actions.ItemLocationsRequest}
